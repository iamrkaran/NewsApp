...
public class DestroyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=findViewById(R.id.custom_camra);
        et_head=findViewById(R.id.del_head);
        et_desc=findViewById(R.id.del_des);
                ...
                dbref.child(getIntent().getStringExtra("category")).
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            startActivity(new Intent(DestroyActivity.this,DestroyActivity.class));
                            finish();
                        }
                        else
                        {
    ...
    private void insertData() {String head,desc;
    ...
    private void showmydialog() {
        ...
        gallery_btn=alertDialog.findViewById(R.id.galary_btn);
